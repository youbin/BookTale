class ClassifiedReviewFeed
  attr_reader	:u_id, :b_id
  alias :id :u_id

  def initialize u_id, b_id
    @u_id = u_id
    @b_id = b_id
  end

  def self.find u_id, b_id
    return self.new u_id, b_id
  end

  def key?
    "classified_feed:review:#@u_id:#@b_id"
  end
